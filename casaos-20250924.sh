...
Welcome_Banner() {
    ...
    echo -e "${GREEN_LINE}"
    echo -e ""
    echo -e " ${aCOLOUR[2]}CasaOS Project  : https://ghfast.top/https://github.com/IceWhaleTech/CasaOS"
    echo -e " ${aCOLOUR[2]}CasaOS Team     : https://ghfast.top/https://github.com/IceWhaleTech/CasaOS#maintainers"
